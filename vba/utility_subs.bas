...
Private Sub clean_function_refs()   ' Private -> hidden from Alt+F8; run from the VBE (F5) when needed
    Dim nm As Name
...
' without saving.
Private Sub sweep_name_cruft()   ' Private -> hidden from Alt+F8; run from the VBE (F5) when needed
